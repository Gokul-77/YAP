                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                            <div className="aspect-video bg-black">
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: selectedStream.embed_code }}
                                />
                            </div>
                            <div className="p-6">
                                ...
                                <div className="mt-4 flex gap-4 text-sm text-gray-500 dark:text-gray-400">
                                    <span>🕐 Starts: {new Date(selectedStream.start_time).toLocaleString()}</span>
                                    {selectedStream.end_time && (
                                        <span>🕐 Ends: {new Date(selectedStream.end_time).toLocaleString()}</span>
                                    )}
                                </div>
                            </div>
                        </div>
